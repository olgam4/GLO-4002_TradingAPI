...
import ca.ulaval.glo4002.trading.infrastructure.account.InMemoryHibernateAccountRepository;
...
public class ProdContext implements ApplicationContext {
    ...
    private void registerRepositories() {
        ServiceLocator.register(AccountRepository.class, new InMemoryHibernateAccountRepository());
